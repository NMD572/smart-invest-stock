...
const CONSTANT_INFER_LASTED_IMPACT_OF_PREVIOUS_DAY =
  "CONSTANT_INFER_LASTED_IMPACT_OF_PREVIOUS_DAY";
const CONSTANT_NOTIFICATION_SETTING_INFOR =
...
function clearTimeoutObject(timeoutObject) {
  if (timeoutObject && timeoutObject != null) {
